...
import java.util.Date;
    public class Utilisateur {
        ...
        public void setRegistered_at(java.sql.Date registered_at) {
        ...
        public void setRegistred_at(Date registered_at) {
        ...
        public String toString() {
            return "Utilisateur{" + "id=" + id + ", nom=" + nom +  ", email=" + email + ", mdp=" + password + ", role=" + roles +  "active=" + active +  "Registred_ar=" + registered_at +  '}';
        }
